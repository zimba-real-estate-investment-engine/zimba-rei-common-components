...
class RealEstatePropertySchema(BaseModel):
    ...
    listings: Optional[List[ListingSchema]]   # many listing sites might have the same property
    target_listing: Optional[ListingSchema]   # this property that will be used in underwriting
