...
def test_crud_deal_model_with_real_estate_property_underwriting(
        get_test_deal_model, get_test_underwriting_model_min, get_test_real_estate_property_model, get_test_db):
    session = get_test_db
    test_deal = get_test_deal_model
    test_underwriting = get_test_underwriting_model_min
    ...
    # Now create the deal
    test_deal.underwriting = existing_underwriting
    test_deal.real_estate_property = test_real_estate_property
