"""create_all_10_tables

Revision ID: 1dacfa03f548
Revises: b3a88d3bbf32
Create Date: 2024-11-24 00:12:24.959696
...
revision: str = '1dacfa03f548'
down_revision: Union[str, None] = 'b3a88d3bbf32'
...
def downgrade() -> None:
    ...
    # Drop schema
    op.execute('DROP SCHEMA IF EXISTS "zimba-rei-micro"')